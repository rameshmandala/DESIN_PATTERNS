package com.mylearning.designpatterns.A0011_Memento;
...
class DvdDetails {
   ...
   private static String getStarsString(ArrayList starsIn) {
       ...
       final ListIterator starsIterator = starsIn.listIterator();
   ...
   public DvdMemento createDvdMemento() {
       final DvdMemento mementoToReturn = new DvdMemento();
...
public class MementoDemo1
{
   public static void main(String[] args) {
       ...
       final ArrayList stars = new ArrayList();
       stars.add(new String("Guy Pearce"));
       final DvdDetails dvdDetails =
