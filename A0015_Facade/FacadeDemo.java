package com.mylearning.designpatterns.A0015_Facade;
...
class FacadeCuppaMaker {
   ...
   public FacadeTeaCup makeACuppa() {
       final FacadeTeaCup cup = new FacadeTeaCup();
       final FacadeTeaBag teaBag = new FacadeTeaBag();
       final FacadeWater water = new FacadeWater();
...
public class FacadeDemo {
   public static void main(String[] args) {
       final FacadeCuppaMaker cuppaMaker = new FacadeCuppaMaker();
