package com.mylearning.designpatterns.A0009_Prototype;
...
public class TestPrototype {
  public static void main(String[] arguments) {
    ...
    final Address address1 = new Address("8445 Silverado Trail", "Rutherford",
        "CA", "91734");
    ...
    final Address address2 = (Address) address1.copy();
