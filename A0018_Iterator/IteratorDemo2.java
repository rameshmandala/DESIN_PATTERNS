...
public class IteratorDemo {
   ...
   public static void main(String[] args) {
       final DvdList fiveShakespeareMovies = new DvdList();
	   ...
	   fiveShakespeareMovies.append("3 idiots");
       final DvdListIterator fiveShakespeareIterator =
