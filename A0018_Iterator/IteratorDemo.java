package com.mylearning.designpatterns.A0018_Iterator;
...
class IntSet {
   ...
   public static class Iterator {
      ...
      public void    next()        {
         ...
         catch (final NoSuchElementException e) { current = null; }
   }  }
...
class IteratorDemo {
   public static void main( String[] args ) {
      ...
      for (int i=1; i < 9; i++)
    {
      ...
      final IntSet.Iterator it1 = set.createIterator();
      final IntSet.Iterator it2 = set.createIterator();
      ...
      for ( it1.first(), it2.first();  ! it1.isDone();  it1.next(), it2.next() )
    {
      ...
      System.out.print( "\nEnumeration: " );
      for (final Enumeration e = set.getHashtable().keys(); e.hasMoreElements(); )
    {
