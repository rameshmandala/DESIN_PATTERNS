...
public class MediatorDemo {
    public static void main(String [] arguments){
        ...
        final Contact contact1 = new ContactImpl("Duke", "", "Java Advocate", "The Patterns Guild");
        final ContactMediatorImpl mediator = new ContactMediatorImpl();
        mediator.addContact(contact);
        mediator.addContact(contact1);
        final MediatorGui gui = new MediatorGui();
...
class ContactMediatorImpl implements ContactMediator{
    ...
    public void createContact(String firstName, String lastName, String title, String organization){
        final Contact newContact = new ContactImpl(firstName, lastName, title, organization);
    ...
    public void updateContact(String firstName, String lastName, String title, String organization){
        final Contact updateContact = (Contact)contacts.get(contactIndex);
...
class MediatorGui{
    ...
    public void createGui(){
        final JFrame mainFrame = new JFrame("Mediator example");
        final Container content = mainFrame.getContentPane();
        content.setLayout(new BoxLayout(content, BoxLayout.Y_AXIS));
        final ContactSelectorPanel select = new ContactSelectorPanel(mediator);
        final ContactDisplayPanel display = new ContactDisplayPanel(mediator);
        final ContactEditorPanel edit = new ContactEditorPanel(mediator);
        content.add(select);
        content.add(display);
        content.add(edit);
