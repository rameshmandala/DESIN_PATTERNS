...
class DvdLowercaseTitle extends DvdTitle {
   ...
   private final DvdMediator dvdMediator;
...
class MediatorDemo {
   public static void main(String[] args) {
       final DvdMediator dvdMediator = new DvdMediator();
       final DvdLowercaseTitle dvdLower =   new DvdLowercaseTitle("Mulholland Dr.", dvdMediator);
       final DvdUpcaseTitle dvdUp =   new DvdUpcaseTitle(dvdLower, dvdMediator);
